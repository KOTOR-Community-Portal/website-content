...
There are also several versions of KOTOR 2 for computers, however: the disk versions; the Steam, GOG and Mac Appstore versions; and the various versions released through other digital retailers. All of these are more-or-less identical, save that it's a little bit harder to mod the Mac store version, but the biggest differences are between the Steam, GoG, and Mac Appstore version and the other versions. Steam/GoG/Mac Appstore have a patch (called the Aspyr patch) that the other versions don't which adds native widescreen and controller support, as well as (for Steam only) Steam Workshop support for modding (though it's very poor for compatibility), but it also introduces a variety of other issues.

You may be thinking to yourself, "well I'll just buy it elsewhere then." Unfortunately it's not that simple; other game versions are *generally* somewhat less stable on modern hardware than the Aspyr-patched game versions. This instability is generally minor and mostly fixed by [making the executable Large Address Aware](https://ntcore.com/?page_id=371), but this does **NOT** apply to widescreen application. For KOTOR 2, the only stable way to apply widescreen to the game is the Aspyr patch; the Aspyr version offers the only extant support for most resolutions, and even tools like UniWS which do allow for support of certain resolutions like 1920x1080 are seriously unstable even after the executable has been made large address aware.

Bottom-line: if you want controller support or widescreen functionality, you should be looking to purchase a copy of KOTOR 2 via a storefront which offers the patched version. Thankfully, through the hard work of the community, on both Steam and GoG (though not the Appstore version sadly) almost all of the issues of the Aspyr version can be resolved. Protecting saves is as simple as disabling cloud saves on Steam versions; for everything else, there's the [3C-FD Patcher](https://deadlystream.com/files/file/2734-fog-fix-more-3c-fd-patcher/), an absolute black magic tool which reverts the vast majority of content broken by Aspyr. Two other standalone mods, the [Water Restoration](https://deadlystream.com/files/file/2758-water-restoration/) and [Stutter Fix](https://deadlystream.com/files/file/2699-stutter-fix-and-force-cage-update/) resolve the other two major problems.
...
If you're familiar with D&D, KOTOR's combat system is built off of a variant of D&D 3.5, and it's quite similar to it in most of the important respects. If you're not familiar or want a refresher, you can take a look at the main wiki's [mechanics section](/faq/k2#mechanics-questions).

Character building in KOTOR 2 is **very important** to unlocking some elements of the plot--it's like Planescape: Torment in that respect. If you want to get the most out of the story, we recommend [building a specific starting character archetype](/faq/k2#what-kind-of-build-is-best-for-getting-the-most-out-of-the-story). But thankfully, since KOTOR 2 adds prestige classes, you can begin as the recommended 14-INT Sentinel and still shift into a prestige class that's more reflective of the sort of combat archetype you'd like to be.
