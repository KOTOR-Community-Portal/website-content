...
There are companion quests which have a certain semi-required planet order to them. If you'd like to complete all of them, you'll need to play your game in a certain way; see [here](/faq/k1#is-there-an-optimal-order-in-which-i-should-visit-planets) for more info, though be aware this guide does contain more significant spoilers!
...
If you're familiar with D&D, KOTOR's combat system is built off of a variant of D&D 3.5, and it's quite similar to it in most of the important respects. If you're not familiar or want a refresher, you can take a look at the main wiki's [mechanics section](/faq/k1#mechanics-questions).

For specific help on building characters of various types, see the [character build](/faq/k1#character-build-suggestions) section of the wiki.
