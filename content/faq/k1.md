...
The fourth option is the most time-consuming, but also has the highest success rate and is the most functional option, as it allows you to play KOTOR not only in fullscreen, but also in widescreen whilst also almost always fixing the issue. It will require you to first follow the instructions in [this video](https://www.youtube.com/watch?v=DSizFARnwyM) to apply widescreen, and then to either apply high-resolution cutscenes from [this mod](https://deadlystream.com/files/file/2380-k1-cutscenes-rescaled/) (not guaranteed to work, but almost always does and much faster & crisper than the other option) or utilize the .bik movie rescaling in [this video](https://www.youtube.com/watch?v=bA5l6HVs4Y4&list=PL4turVkHE16-AFfklPEGFU3rhyu6lFyjO&index=11). Please note that the hex codes for your given resolution will come pre-edited, if you get confused while watching the second video. Please note also that 1366x768 **is not supported** by this method, and indeed cannot mechanically function ingame, unless you use [this mod](https://deadlystream.com/files/file/1159-kotor-high-resolution-menus/?tab=comments) along with its letterbox scaling option, which will allow 1366x768 (and other resolutions of similar aspect ratio) to function normally.
...
1. For nVidia users: Download nVidia Inspector from here - https://github.com/Orbmu2k/nvidiaProfileInspector/releases/latest
...
### There are crazy lines all over my screen and in the sky / I'm lagging badly in the Taris Undercity!

This is a common rendering issue with the game's management of grass effects. It happens for a wide variety of people on a wide variety of setups and there is no real reliable fix; either you can render it properly or you can't. So if you're getting bad lag and/or crazy lines, just open swkotor.ini with a text editor like notepad, find the line Grass=1 under the Graphics Options heading, set it to Grass=0, and save the file. It will fix your issue.
...
Although it is at this time very outdated, [this page](/modding/mod_builds/macos) (copied from a thread on reddit by sentient06, with our thanks) is the best guide currently available for Mac setup. We are actively looking for a current Mac user to help us write a more up-to-date guide, so please contact us if you would be able to assist!

### How do I get KOTOR running in widescreen?

Following the steps in [this video](https://www.youtube.com/watch?v=DSizFARnwyM) will get KOTOR running in widescreen, but you may run into issues with the fullscreen bug (cutscenes causing crashes or minimizations to desktop, especially when playing back-to-back).

To fix this, you can apply high-resolution cutscenes from [this mod](https://deadlystream.com/files/file/2380-k1-cutscenes-rescaled/) (not guaranteed to work, but almost always does and much faster & crisper than the other option) or utilize the .bik movie rescaling in [this video](https://www.youtube.com/watch?v=bA5l6HVs4Y4&list=PL4turVkHE16-AFfklPEGFU3rhyu6lFyjO&index=11). Please note that the hex codes for your given resolution will come pre-edited, if you get confused while watching the second video. Please note also that 1366x768 **is not supported** by this method, and indeed cannot mechanically function ingame, unless you use [this mod](https://deadlystream.com/files/file/1159-kotor-high-resolution-menus/?tab=comments) along with its letterbox scaling option, which will allow 1366x768 (and other resolutions of similar aspect ratio) to function normally.

### My framerate is terrible despite having a powerful computer!
...
It strongly depends on your intended playstyle. Having more Jedi levels doesn't make your final build inherently stronger. There are some feats and bonuses which only your base class has access to, and missing out on them can actually sometimes make your final character much weaker. For example, a Scoundrel gains Sneak Attack, which multiplies damage done against targets you are physically behind in the game world; which are stunned or otherwise incapacitated; or which you strike from stealth. If you only invested 2 levels into this base class, you would miss several Sneak Attack levels and would inadvertently make your final build much weaker, not stronger.

There is often very good reason to not over-level your base class--for instance, maybe you stop leveling at 4 or 5, and you almost never want to level it beyond 8. But there is often good reason to invest at least a few levels into it, except on very specific builds.
...
2) There are "trigger" areas on each of the four planets. The first trigger area you visit will trigger Boss 1 and the first trigger area you visit after grabbing your 4th Star Map (including Dantooine's) will trigger Boss 2. They can be the same area. This only really matters because Boss 1 drops his best loot on Tattooine and Korriban.
...
5) Yavin Station (available on PC, Switch, Mobile & Xbox digital download versions *only*) restocks after getting your 3rd and 5th Star Maps, so be sure to pay it visits at these stages.
...
8) If you want to do the Genoharadan Assassination Quests, make sure you complete them before getting your final star map. Additionally, do these ASAP if you are LS or you won't have much chance to undo the DS points you get.
...
4) Go to Manaan and start/complete the Genoharadan Assassination quests
...
Go see Dak in the Valley of the Sith Lords (Korriban) with Juhani in your party which sends him to the cantina. Then head to the Cantina and kill him for 150 Credits, Dark Jedi Knight Robe and an Eralam Crystal. BUT if you rezone in and out of the cantina, he respawns! This is by far the fastest way to make money in KOTOR. Note that you get DS points for doing this each time, so this may not be an option if you are LS. However, you could in theory combine this with the Kashyyyk infinite LS points glitch (also unavailable if the Community Patch is applied)
...
Most of these quests are unlocked after a certain specific trigger is met, usually the number of star maps you've found, while also completing their available dialogue up to that point. Usually, their quest begins by leaving the *Ebon Hawk* with them in tow on certain planets (and, again, after having unlocked the requisite number of star maps and dialogues for their quests), at which time the companion will meet a person that they know. That person will reveal something important to them and, in so doing, unlock their quests. There is an exception to this, however, in Zaalbar and Jolee's quests: Zaalbar's quest is mandatory and occurs on Kashyyyk, and Jolee's quest can begin on Manaan by talking to a certain NPC whether or not you've met Jolee's old friend whilst exiting the '*Hawk*.

Only certain companions can meet their companion quest-giving NPCs on any given planet, with the exception of Dantooine, where every companion can meet their related NPC. For this reason, it is advisable to return to Dantooine after finding each star map and exit the *Ebon Hawk* individually with all companions, to maximize the chances of getting their quest quickly. This can be (and indeed should be) done with Mission and Bastila before even leaving Dantooine, to acquire both of their related quests, as both Mission and Bastila's quests occur on Tatooine, which is the first planet in the most logical KOTOR planet order.
...
If you are female, you can pursue a romance with Carth or with Juhani, although Juhani's romance is very buggy if not using the [KOTOR Community Patch](https://deadlystream.com/files/file/1258-kotor-1-community-patch/). If you are male, you can pursue a romance with Bastila.

For Carth or Bastila, you don't have to really do anything special. Just talking to them and picking friendly responses will start you on the right track, although for Bastila there is a point where you can sort of press the issue and afterwards, unless you have a mod that fixes the glitch (the KOTOR Community Patch does so), you should not speak to her again without her initiating the conversation, or a glitch will kill the romance plot.
...
Delete your Override Folder. Also, go into your Modules folder and erase all of the .mod files. Other mod data might remain but it will not significantly impact your install, *unless* the main dialog.tlk file in the main game directory was edited. If it was you will need to delete it and reverify your game files (Steam) or reinstall your game entirely.

If you want to be absolutely positive you got all mod data, the only totally reliable blank-slate method is to uninstall the game fully, delete the entire remaining game folder after the uninstall has occurred, and reinstall the game.
...
If you have concerns over whether or not your personal build will work, post in the [#tech_support channel of the KOTOR Discord](https://discord.gg/kotor#tech_support) for compatibility advice.
